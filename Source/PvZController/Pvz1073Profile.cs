...
internal static class Pvz1073Profile
{
    ...
    internal const uint BoardNumWaves = 0x557C;
    internal const uint BoardCurrentWave = 0x5594;
    internal const uint BoardTotalSpawnedWaves = 0x5598;
    internal const uint BoardZombieHealthToNextWave = 0x55AC;
    internal const uint BoardZombieCountDown = 0x55B4;
    internal const uint BoardZombieCountDownStart = 0x55B8;
    internal const uint BoardHugeWaveCountDown = 0x55BC;
    internal const uint BoardLevelComplete = 0x5614;
    internal const uint BoardBoardFadeOutCounter = 0x5618;
    internal const uint BoardNextSurvivalStageCounter = 0x561C;
    internal const uint BoardProgressMeterWidth = 0x5628;
    internal const uint BoardFlagRaiseCounter = 0x562C;
    internal const uint BoardLevelAwardSpawned = 0x5624;
